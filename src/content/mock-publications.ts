...
export const mockPublications: Publication[] = [
  {
    ...
    authors: { ko: '신종천', en: 'Jongcheon Shin', zh: '辛鍾天' },
    featured: true,
    published: true,
  ...
  },
  {
    ...
    authors: { ko: '신종천, 김민재', en: 'Jongcheon Shin, Minjae Kim', zh: '辛鍾天, 金敏载' },
    featured: true,
    published: true,
  ...
  },
  {
    ...
    authors: { ko: '신종천, 박수연', en: 'Jongcheon Shin, Suyeon Park', zh: '辛鍾天, 朴秀妍' },
    featured: false,
    published: true,
  ...
  },
  {
    ...
    authors: { ko: '신종천, 이현우', en: 'Jongcheon Shin, Hyunwoo Lee', zh: '辛鍾天, 李炫宇' },
    featured: true,
    published: true,
  ...
  },
  {
    ...
    authors: { ko: '신종천, 조영호, 강민지', en: 'Jongcheon Shin, Youngho Cho, Minji Kang', zh: '辛鍾天, 赵英浩, 姜敏智' },
    featured: false,
    published: true,
